...
const messageList = ref<ChatMessage[]>([
  {
    role: "system",
    content: '你好，我是 ChatGPT，OpenAI 训练的大型语言模型，尽可能简洁地回答。',
  },
  {
    role: "assistant",
    content: '你好，我是 ChatGPT，OpenAI 训练的大型语言模型，尽可能简洁地回答。',
...
const sendChatMessage = async (content: string = messageContent.value) => {
  try {
    ...
    const prompt= `将这个对象 ${content}生成一个对象数组，其中的key翻译成中文作为label的值，其中的value作为‘value’的值放入到这个对象数组中，请直接返回代码结果，无需太多过程描述。`
    messageList.value.push({ role: "user", content:prompt});
